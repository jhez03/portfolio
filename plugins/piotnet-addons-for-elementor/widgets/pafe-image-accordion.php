...
class PAFE_Image_Accordion extends \Elementor\Widget_Base
{
    ...
    {
        $this->pafe_image_accordion_controls();
    }
    ...
    public function pafe_image_accordion_controls()
    {
    ...
    protected function render()
    {
        ...
        ?>
        <div class="pafe-image-accordion" data-pafe-image-accordion-list
            data-pafe-image-accordion-option='<?php echo esc_html($settings['pafe_image_accordion_trigger_type']); ?>'>
            <?php
            $index = 0;
            foreach ($settings['pafe_image_accordion'] as $item):
                $index++;
                ?>
                <div class="pafe-image-accordion__item<?php if ($index == 1) {
                    echo " active";
                } ?>" data-pafe-image-accordion-item>
                    ...
                    <div class="pafe-image-accordion__item-content" data-pafe-image-accordion-item-content>
                        <?php if (!empty($item['pafe_image_accordion_item_title'])): ?>
                            <div class="pafe-image-accordion__item-content__title">
                                <h2 class="pafe-image-accordion__item-content__title-inner">
                                    <?php echo esc_html($item['pafe_image_accordion_item_title']); ?>
                            </div>
                        <?php endif; ?>
                        <div class="pafe-image-accordion__item-content__text">
                            ...
                            <?php if (!empty($item['pafe_image_accordion_item_link']) && !empty($item['pafe_image_accordion_item_button_text'])): ?>
                                <a class="pafe-image-accordion__item-content__link"
                                    href="<?php echo esc_url($item['pafe_image_accordion_item_link']); ?>"><?php echo esc_html($item['pafe_image_accordion_item_button_text']); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
